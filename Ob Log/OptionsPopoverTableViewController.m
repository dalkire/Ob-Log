//
//  OptionsPopoverTableViewController.m
//  Ob Log
//
...
@implementation OptionsPopoverTableViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        for (int i = 0; i < 9; i++) {
            [self.optionsArray addObject:[NSString stringWithFormat:@"option no. %d", i]];
        }
    }
    return self;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [delegate didSelectOptionRowAtIndexPath:indexPath];
}
